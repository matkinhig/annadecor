<div id="dokan-seller-listing-wrap">
    <div class="seller-listing-content">
                        ...
                        <div class="store-wrapper">
                            <div class="store-content">
                                <div class="store-info-1 p_r">
                                    <img src="<?php echo is_array($store_banner_url) ? esc_attr($store_banner_url[0]) : esc_attr($store_banner_url); ?>" alt="<?php esc_html_e('Store Banner', 'xtocky'); ?>">
                                    <?php if ($is_store_featured) : ?>
                                            <div class="featured-label"><?php esc_html_e('Featured', 'xtocky'); ?></div>
                                        <?php endif ?>
                                </div>
                            </div>
                            <div class="store-footer">
                                ...
                                <div class="store-data-container">
                                    ...
                                    <div class="store-data t_c mt40">
                                        ...
                                        <?php if (!empty($store_rating['count'])) : ?>
                                            <div class="star-rating dokan-seller-rating" title="<?php echo sprintf(esc_attr__('Rated %s out of 5', 'xtocky'), esc_attr($store_rating['rating'])) ?>">
                                                <span style="width: <?php echo (esc_attr(($store_rating['rating'] / 5)) * 100 - 1); ?>%">
                                                    <strong class="rating"><?php echo esc_html($store_rating['rating']); ?></strong> <?php _e('out of 5', 'xtocky'); ?>
                                                </span>
                                            </div>
                                        <?php endif ?>
                                ...
                                <a href="<?php echo esc_url($store_url); ?>" class="dokan-btn dokan-btn-theme"><?php esc_html_e('Visit Store', 'xtocky'); ?></a>
            ...
            <?php
                ...
                if ($num_of_pages > 1) {
                    ...
                    $pagination_args = array(
                        ...
                        'type'      => 'array',
                        'prev_text'    => '<i class="icon-arrow-long-left"></i>',
			            'next_text'    => '<i class="icon-arrow-long-right"></i>',
                    );
                    ...
                    if ($page_links) {
                        ...
                        $pagination_links .= '<ul class="page-numbers"><li>';
                        $pagination_links .= join("</li>\n\t<li>", $page_links);
                        $pagination_links .= "</li>\n</ul>\n";
                        $pagination_links .= '</div>';

                        echo do_shortcode( $pagination_links ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
                    }
        ...
        <?php else :  ?>
            <p class="dokan-error"><?php esc_html_e('No vendor found!', 'xtocky'); ?></p>
        <?php endif; ?>
    </div>
</div>