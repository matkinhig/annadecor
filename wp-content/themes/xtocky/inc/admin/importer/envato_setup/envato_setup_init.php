				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'xtocky' ),
							'description' => __( 'Upgrade Content and Settings', 'xtocky' ),
							'pending' => __( 'Pending.', 'xtocky' ),
							'installing' => __( 'Installing Updates.', 'xtocky' ),
							'success' => __( 'Success.', 'xtocky' ),
