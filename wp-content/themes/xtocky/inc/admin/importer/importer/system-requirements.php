...
class Xtocky_System_Requirements{
	...
	public function html() {
		...
		echo '<table class="widefat">';
			printf(
				...
				<th>%s</th>
				<th>%s</th></thead>',
				esc_html__( 'Environment', 'xtocky' ),
				esc_html__( 'Requirement', 'xtocky' ),
				esc_html__( 'System', 'xtocky' )
			);

			printf(
				'<tr class="wp-system %s">
					<td>' . esc_html__( 'WP File System:', 'xtocky' ) . '</td>
					<td>%s</td>
			...
			printf(
				'<tr class="php-version">
					<td>' . esc_html__( 'PHP version:', 'xtocky' ) . '</td>
					<td>%s</td>
			...
			printf(
				'<tr class="wp-version">
					<td>' . esc_html__( 'WordPress version:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s %s"></span></td>
				</tr>',
			...
			printf(
				'<tr class="memory-limit">
					<td>' . esc_html__( 'Memory limit:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s %s"></span></td>
				</tr>',
			...
			printf(
				'<tr class="execution-time %s %s">
					<td>' . esc_html__( 'Max execution time:', 'xtocky' ) . '</td>
					<td>min (%s-%s)</td>
			...
			printf(
				'<tr class="input-vars %s %s">
					<td>' . esc_html__( 'Max input vars:', 'xtocky' ) . '</td>
					<td>min (%s-%s)</td>
					<td>%s<span class="dashicons dashicons-%s %s"></span></td>
				</tr>',
			...
			printf(
				'<tr class="filesize">
					<td>' . esc_html__( 'Upload max filesize:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s %s"></span></td>
				</tr>',
			...
			printf(
				'<tr class="uploads-folder">
					<td>' . esc_html__( '../Uploads folder:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s "></span></td>
				</tr>',
				'writable',
			...
			printf(
				'<tr class="ssl-version">
					<td>' . esc_html__( 'OpenSSL version:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s %s"></span></td>
				</tr>',
			...
			printf(
				'<tr class="gzip-compression">
					<td>' . esc_html__( 'GZIP compression:', 'xtocky' ) . '</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s "></span></td>
				</tr>',
				'enable',
			...
			printf(
				'<tr class="function-f_get_contents">
					<td>file get_contents():</td>
					<td>%s</td>
					<td>%s<span class="dashicons dashicons-%s "></span></td>
				</tr>',
