...
<div class="ocdi">
	...
	<?php else : ?>
		...
		<div class="ocdi__gl  js-ocdi-gl">
			...
			<?php endif; ?>
			<div class="ocdi__gl-item-container  wp-clearfix  js-ocdi-gl-item-container import-demos">
				<?php foreach ($predefined_themes as $index => $import_file) : ?>
					...
					?>
					<div class="version-demo ocdi__gl-item js-ocdi-gl-item" data-categories="<?php echo esc_attr(Helpers::get_demo_import_item_categories($import_file)); ?>" data-name="<?php echo esc_attr(strtolower($import_file['import_file_name'])); ?>">
						...
						<div class="version-screen ocdi__gl-item-footer<?php echo !empty($import_file['preview_url']) ? '  ocdi__gl-item-footer--with-preview' : ''; ?>">

							<button class="piko-button button-import-version ocdi__gl-item-button js-ocdi-gl-import-data" value="<?php echo esc_attr($index); ?>"><?php esc_html_e('Import', 'pt-ocdi'); ?></button>
							<?php if (!empty($import_file['preview_url'])) : ?>
								<a class="demo-preview ocdi__gl-item-button" href="<?php echo esc_url($import_file['preview_url']); ?>" target="_blank"><?php esc_html_e('Preview', 'pt-ocdi'); ?></a>
							<?php endif; ?>
						</div>
						<span class="version-title ocdi__gl-item-title" title="<?php echo esc_attr($import_file['import_file_name']); ?>"><?php echo esc_html($import_file['import_file_name']); ?></sapn>
					</div>
				<?php endforeach; ?>
				<div class="loading-info js-ocdi-ajax-loader">
					...
					<h3><?php esc_html_e('Dummy Data Importing', 'pikoworks_dummy'); ?><em><?php esc_html_e('Please wait, it may process 1 to 10 minutes.', 'pikoworks_dummy'); ?></em></h3>
				</div>
			</div>
		</div>
