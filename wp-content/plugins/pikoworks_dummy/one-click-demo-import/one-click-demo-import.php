...
class OCDI_Plugin {
	...
	private function set_plugin_constants() {
		...
		if ( ! defined( 'PT_OCDI_PATH' ) ) {
			define( 'PT_OCDI_PATH', PIKOWORKS_DUMMY_DIR_PATH. 'one-click-demo-import/' );
		}
		if ( ! defined( 'PT_OCDI_URL' ) ) {
			define( 'PT_OCDI_URL', PIKOWORKS_DUMMY_BASE_URL. 'one-click-demo-import/' );
		}
	...
	public function set_plugin_version_constant() {
		if ( ! defined( 'PT_OCDI_VERSION' ) ) {
			define( 'PT_OCDI_VERSION', PIKOWORKS_DUMMY_VERSION );
		}
	}
}
