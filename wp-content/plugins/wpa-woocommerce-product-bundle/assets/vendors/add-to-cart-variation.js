;(function ( $, window, document, undefined ) {
	...
	VariationForm.prototype.onFoundVariation = function( event, variation ) {
		...
		var parent_tr = form.$form.closest( 'tr' ),
			link_id   = form.$form.closest( 'tr' ).attr( 'data-link' ),
			percent   = form.$form.closest( '#wpa_wcpb_product_data' ).find( '.saved-percent td[data-link="' + link_id + '"] input' );

		percent.attr( 'data-price', variation.display_price );
